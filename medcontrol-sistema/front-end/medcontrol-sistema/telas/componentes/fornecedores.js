export function render() {
  ...
  setTimeout(() => {
      ...
      fetch('https://medcontrol-backend.onrender.com/dashboard_fornecedores_total')
      .then((resposta) => {
        if (resposta.ok) {
    ...
    // Total de fornecedores ativos:
      ...
      fetch('https://medcontrol-backend.onrender.com/dashboard_fornecedores_ativos')
      .then((resposta) => {
        if (resposta.ok) {
          return resposta.json();
        } else {
    ...
    // Total de fornecedores inativos:
      ...
      fetch('https://medcontrol-backend.onrender.com/dashboard_fornecedores_inativos')
      .then((resposta) => {
        if (resposta.ok) {
          return resposta.json();
        } else {
  ...
  setTimeout(() => {
    ...
    form.addEventListener("submit", async (event) => {
      ...
      try {
        const resposta = await fetch("https://medcontrol-backend.onrender.com/cadastro_fornecedores", {
          method: "POST",
  ...
  setTimeout(() => {
    ...
    fetch('https://medcontrol-backend.onrender.com/tabela_fornecedores')  
    .then((response) => {
    if (response.ok) {
  ...
  // Script para salvar os dados editados:------------------------------------------------------ 
              ...
              form.addEventListener("submit", async (event) => {
                  ...
                  try {
                      ...
                      const resposta = await fetch(`https://medcontrol-backend.onrender.com/editar_fornecedores/${id_fornecedor}`, {
                      method: "POST",
                      headers: {
  ...
  table.addEventListener('click', async (event) => {
      ...
      const id_fornecedor = linha.getAttribute('data-id_fornecedor');
          ...
          try {
              const resposta = await fetch(`https://medcontrol-backend.onrender.com/deletar_fornecedor/${id_fornecedor}`, {
              method: 'DELETE'
              });
